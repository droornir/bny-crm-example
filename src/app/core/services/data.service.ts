...
import {ICustomer, IOrder, IState, IPagedResults, IApiResponse, IOrderWrapper} from '../../shared/interfaces';
...
export class DataService {
  ...
  insertOrder(order: IOrderWrapper): Observable<IOrderWrapper> {
    return this.http.post<IOrderWrapper>('/api/orders', order)
      .pipe(catchError(this.handleError));
  }
